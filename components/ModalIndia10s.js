                ...
                <ModalBody >
                    <div class="sidebar-item px-4">
                        <div class="form-content rounded overflow-hidden" >
                            <form  onSubmit={handleSubmit} id="india_pop_submit_10s"  >
                              <div className="form-group mb-2">
                                ...
                                <div class="comment-btn text-center">
                                    {/* <input type="submit" class="nir-btn2" data-callback='submit' id="india_pop_submit_10s" value="Send Enquiry" disabled={!formValid}/> */}
                                    <input type="submit" style={{background:"#B3282F"}} className={`nir-btn col-lg-4 py-1 btn_responsive ${!formValid ? 'disabledButton' : ''}`} data-callback='submit' id="india_pop_submit_10s" value="Send Enquiry" disabled={!formValid} />
                                </div><br />
                            </form>
