...
const url = 'https://backend.tripzygo.in/modalcontact';
...
function App(props) {
    ...
    const handleContact = async (e) => {
        try {
            axios.post(url, { name, email_id, country_code, phone_no, next_destination, no_of_passengers, date_of_travel, personalized_message });
        } catch (error) { }
    };
    ...
    return (
        <div>
            <Modal isOpen={modal} toggle={toggle} id="myModal">
                <img className="homeModalImage" src={props.ImageLink} alt={props.alt}></img>
                ...
                <ModalHeader
                    id="homeModalHeader" toggle={toggle}><p>Hey, Let Us Know Your Plans!</p></ModalHeader>
                <ModalBody>
                    <div class="sidebar-item px-1">
                        <div class="form-content rounded overflow-hidden" >
                            <form method="post" action="#" onSubmit={handleSubmit} name="contactform2" >
                                <div className='row mx-2 mt-2'>
                                    <div className="col-lg-4 col-md-4 col-sm-12 mb-1 px-1">
                                    ...
                                    <div className=" col-lg-4 col-md-4 mb-1 px-1">
                            ...
                            <datalist id="country_list">
                              ...
                              <option value="Kanchipuram">Kanchipuram</option>
                                ...
                                <div className="row mx-2" >
                                    <div className='d-flex col-lg-4 col-sm-12 col-md-4 px-0'>
                                    ...
                                    <div className="col-lg-4 col-md-3 mb-1 px-1">
                                    ...
                                    <div className=" col-lg-4 col-md-5 mb-1 px-1">
                                        <input type="date" name="date_of_travel" min={currentDate} value={date_of_travel} className="form-control c2" id="startdate" placeholder="Departure:&nbsp;" onChange={(e) => setSdate(e.target.value)} required />
                                    </div>
                                </div>
                                <div className="row px-2">
                                    <div className="textarea col-lg-12 col-md-12 mb-1">
                                        <textarea style={{ height: "50px" }} name="personalized_message" value={personalized_message} placeholder="Share your message (optional)" onChange={(e) => setMessage(e.target.value)} ></textarea>
                                    </div>
                                    ...
                                    <div className="comment-btn text-center col-lg-12 col-md-12" style={{ marginBottom: "10px" }}>
                                        <button type="submit" className="nir-btn2" data-callback='submit' id="pop_homepage" value="Send Enquiry" >Send Enquiry</button>
                                    </div>
                                </div>
                            </form>
                        </div>
