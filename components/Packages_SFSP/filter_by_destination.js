...
const Destination_search = (props) => {
            ...
            <div className="sidebar-sticky resp tabResp">
                <div className="list-sidebar">
                    <div className="sidebar-item mb-4">
                        <p style={{ fontSize: "22px", color: "#0d4980", fontWeight: "400" }}>Filter <p style={{ marginLeft: "200px", color: "white !important" }} className="nir-btn1" onClick={props.reset} >Reset</p></p>
