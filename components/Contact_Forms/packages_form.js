...
export default function packages_form(props) {
    ...
    const [packageURL, setPackageURL] = useState(props.props3);
    ...
    return (
        <div>
            <div class="sidebar-sticky resp shadow-sm rounded" style={{ display: props.display }}>
                <div class="list-sidebar">
                    <div class="sidebar-item">
                        <div class="form-content rounded overflow-hidden" >
                            <h4 class="text-center border-b pb-2" style={{ fontSize: "16px" }}>{props.props2}{props.label}</h4>
                            <div class="row">
                                <form method="post" action="#" onSubmit={handleSubmit} name="contactform2" id='pop_signup' ref={formRef}>
                                    ...
                                    {/* <div className="textarea mb-2">
                                        <textarea style={{ height: "70px" }} name="personalized_message" value={personalized_message} placeholder="Share your message (optional)" onChange={(e) => setMessage(e.target.value)} ></textarea>
                                    </div> */}
                                    {/* <div className="form-group mb-0" style={{ fontSize: "11px", height: "10px" }}>
                                        <input
                                            type="checkbox"
                                            name="whatsapp"
                                            value="whatsapp"
                                        ...
                                        />&nbsp;
                                        Let us send you more updates on WhatsApp
                                    </div> */}
                                    ...
                                    <div className="comment-btn text-center pt-1">
                                        {/* <button type="submit" className="nir-btn2" data-callback='submit' id="pop_submit_form" value="Send Enquiry">Send Enquiry</button> */}
                                    <input type="submit" style={{background:"#B3282F"}} className={`nir-btn2 btn_responsive ${!formValid ? 'disabledButton' : ''}`} data-callback='submit' id="pop_submit_form" value="Send Enquiry" disabled={!formValid} />
