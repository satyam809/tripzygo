                        ...
                        <div class="form-content rounded overflow-hidden" >
                            ...
                            <div className="form-group mb-2">
                                ...
                                <div class="comment-btn text-center">
                                    {/* <input type="submit" class="nir-btn2" data-callback='submit' id="international_footer_se" value="Send Enquiry" /> */}
                                    <input type="submit" style={{background:"#B3282F"}} className={`nir-btn2 btn_responsive ${!formValid ? 'disabledButton' : ''}`} data-callback='submit' id="international_footer_se" value="Send Enquiry" disabled={!formValid} />
