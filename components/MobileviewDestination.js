...
function App(props) {
    ...
    return (
        <div>
            {/* <div class="nir-btn col-lg-12 py-1 btn_responsive" onClick={toggle} style={{ fontSize: props.labelSize,borderRadius:props.Radius,float: props.Right, marginLeft: props.Left, marginRight: props.Right, top: props.top, width: props.width, marginTop: props.Top ,borderRadius:props.border }}>{props.buttonLabel}</div> */}
          
              {/* <div class='icon' onClick={toggle} style={{ fontSize: props.labelSize,borderRadius:props.Radius,float: props.Right, marginLeft: props.Left, marginRight: props.Right, top: props.top, width: props.width, marginTop: props.Top ,borderRadius:props.border }}>{props.buttonLabel}
              <i class="fa fa-phone-alt"></i>
              </div>
              <p class='label'>Talk to Us</p> */}
              <div class="button-wrapper-cta" onClick={toggle} style={{ fontSize: props.labelSize,borderRadius:props.Radius,float: props.Right, marginLeft: props.Left, marginRight: props.Right, top: props.top, width: props.width, marginTop: props.Top ,borderRadius:props.border }}>
                             <a class="button-cta cta-button  btn-lg btn-block" style={{textAlign:"center",fontSize:"1rem"}}>Send Enquiry</a>
                           </div>
           
            <Modal toggle={() => setModalOpen(!modalOpen)} isOpen={modalOpen} id="LandingPageModal" name="onClickPopUp">
                {/* <img className="homeModalImage" src="/images/popup/popup.jpg"></img> */}

                <div className=" modal-header border-0">
                    <h5 className=" modal-title" id="exampleModalLabel" style={{ fontWeight: "500", fontSize: "16px", margin: "auto", textAlign:"center" }}>
                        ...
                        <div class="form-content rounded overflow-hidden" >
                            ...
                            <div className="form-group mb-2">
                                ...
                                <div class="comment-btn text-center">
                                    {/* <input type="submit" class="nir-btn2" data-callback='submit' id="tour_list_se" value="Send Enquiry" /> */}
                                    <input type="submit" style={{background:"#B3282F"}} className={`nir-btn2 btn_responsive ${!formValid ? 'disabledButton' : ''}`} data-callback='submit' id="tour_list_se" value="Send Enquiry" disabled={!formValid} />
