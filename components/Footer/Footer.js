        ...
        <div className="footer-upper pb-0">
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-8 col-md-5 d-flex p-0">
...
{/* <a href="https://wa.me/+917814694248?text=Hi" class="whatsapp-button" target="_blank" style={{position:"fixed" , right:"15px" , bottom:"15px"}} >
  <img src="https://i.ibb.co/VgSspjY/whatsapp-button.png" alt="whatsapp" />
</a> */}

<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css"/>

<a href="https://wa.me/+917814694248?text=Hi" target='_blank' class="whatsapp-btn">
