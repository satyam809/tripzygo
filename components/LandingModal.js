...
function App(props) {
    ...
    const [preferred_destination, setDestination] = useState(url_destination);
                        ...
                        <div class="form-content rounded overflow-hidden" >
                            <form method="post" action="#" onSubmit={handleSubmit} name="contactform2" >
                                ...
                                <div class="form-group mb-1">
                                    <div className='d-flex col-lg-12 col-sm-12 col-md-4 px-0'>
                                ...
                                <div className="form-group mb-2">
                                    {/* <input type="date" name="date_of_travel" min={currentDate} value={date_of_travel} className="form-control c2" id="startdate" placeholder="Date of Travel:&nbsp;" onChange={(e) => setDeparture(e.target.value)} required /> */}
                                    <select name="countryCode" className='col-lg-12 mb-0 px-0'
