...
export async function getServerSideProps(){
    ...
    pData = pData.filter(pack => pack.web_pack_price >= 75000 && pack.web_pack_price <= 100000);
    console.log(pData);
    return {
        props: {
            pData,
...
export default function test({pData}) {
    ...
    return (
        <div>
            <Head>
                <title>Book Tour Packages 𝗨𝗻𝗱𝗲𝗿 𝗜𝗡𝗥 𝟭 𝗟𝗮𝗸𝗵</title>
                <meta name="description" content="Embark on a journey of a lifetime with our tour packages under INR 1 lakh. Book now for an unparalleled travel experience and unforgettable memories." />
                <link rel="icon" href="/icon.png" />

            </Head>
            {/* <HomeModal ImageLink="/images/popup/Winter.webp" alt="Winter Tour Packages" /> */}

            <section className="breadcrumb-main pb-6 pt-10" style={{ backgroundImage: "url(/images/banner_images/4.jpg)" }}>
                        ...
                        <div className="breadcrumb-content text-center">
                            <nav aria-label="breadcrumb" className="d-block">
                                <ul className="breadcrumb banner-content">
                                    ...
                                    <h1 className='text-white' id="tourPackagesHeading">Tour Packages Under 1 Lakh</h1><br />
