...
export default function test({pData}) {
    ...
    return (
        <div>
            <Head>
                <title>Book Couple Tour Packages at TripzyGo</title>
                <meta name="description" content="Indulge in romantic getaways! Book a couple tour packages at TripzyGo for memorable experiences. Tailored for love, explore together with our curated packages" />
                <link rel="icon" href="/icon.png" />

            </Head>
            {/* <HomeModal ImageLink="/images/popup/Winter.webp" alt="Winter Tour Packages" /> */}

            <section className="breadcrumb-main pb-6 pt-10" style={{ backgroundImage: "url(/images/banner_images/couple.jpg)" }}>
                        ...
                        <div className="breadcrumb-content text-center">
                            <nav aria-label="breadcrumb" className="d-block">
                                <ul className="breadcrumb banner-content">
                                    ...
                                    <h1 className='text-white' id="tourPackagesHeading">Couple Tour Packages</h1><br />
