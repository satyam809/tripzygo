...
export async function getServerSideProps(){
    ...
    pData = pData.filter(pack =>
        pack.destination_search.split(',').map(keyword => keyword.trim()).includes('Family')
        );
    console.log(pData);
    return {
        props: {
...
export default function test({pData}) {
    ...
    return (
        <div>
            <Head>
                <title>35+ Family Tour Packages 𝗦𝘁𝗮𝗿𝘁𝗶𝗻𝗴 @𝟳𝟴𝟬𝟬</title>
                <meta name="description" content="Discover unforgettable family adventures with our 35+ family tour packages. Your perfect family getaways awaits!" />
                <link rel="icon" href="/icon.png" />

            </Head>
            {/* <HomeModal ImageLink="/images/popup/Winter.webp" alt="Winter Tour Packages" /> */}

            <section className="breadcrumb-main pb-6 pt-10" style={{ backgroundImage: "url(/images/banner_images/family.jpg)" }}>
                        ...
                        <div className="breadcrumb-content text-center">
                            <nav aria-label="breadcrumb" className="d-block">
                                <ul className="breadcrumb banner-content">
                                    ...
                                    <h1 className='text-white' id="tourPackagesHeading">Family Tour Packages</h1><br />
