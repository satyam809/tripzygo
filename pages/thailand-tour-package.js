...
export default function test() {
    ...
    return (
        <>
            <Head>
                <title>TripzyGo - Thailand Tour Package</title>
            ...
            <section class="search-banner landing_bannerthailand  align-items-center pt-8 pb-5">
                <div class="container">
                    <div class="search-banner-in">
                        <div class="row align-items-center">
                            <div class="col-lg-9 col-md-5">
                                <div class="section-title mb-10 text-lg-start text-center">
                                    <h1 class=" white">Thailand Tour Package</h1>
                                    <h4 class=" white">Plan Your Thailand Honeymoon Package With Us! </h4>
            ...
            <section className="trending recent-articles pb-4 pt-4 "  >
                <div className="container delightfulContainer">
                    <div className="section-title mb-6 w-75 mx-auto text-center">
                        <h2 className="mb-1">Explore Our <span className="theme">Thailand Tour Packages</span></h2>
                    ...
                    <div className="recent-articles-inner">
                        <div className="row">
                            <div className="col-lg-4 col-md-6">
                                <div className="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
                                    <div className="trend-image">
                                        <img src="/images/landing/Bangkok Pattaya Packages.webp" />
                                    </div>
                                    <div className="trend-content-main p-4 pb-2">
                                        <div className="trend-content">
                                            <h4 style={{ fontSize: "18px" }}>Bangkok Pattaya Package</h4>
                                            <div className="entry-meta d-flex align-items-center justify-content-between">
                                                <div className="entry-button d-flex align-items-center mb-2">
                                                    <a href="packages/blissful-bangkok-pattaya-tour-package-from-india" target="_blank" className="nir-btn2">View Package</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
                                    <div className="trend-image">
                                        <img src="/images/landing/Phuket Krabi Packages.webp" />
                                    </div>
                                    <div className="trend-content-main p-4 pb-2">
                                        <div className="trend-content">
                                            <h4 style={{ fontSize: "18px" }}>Phuket Krabi Package</h4>
                                            <div className="entry-meta d-flex align-items-center justify-content-between">
                                                <div className="entry-button d-flex align-items-center mb-2">
                                                    <a href="/packages/phuket-krabi-tour-package-in-budget" target="_blank" className="nir-btn2">View Package</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="col-lg-4">
                                <div className="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
                                    <div className="trend-image">
                                        <img src="/images/landing/Thailand Honeymoon Packages.webp" />
                                    </div>
                                    <div className="trend-content-main p-4 pb-2">
                                        <div className="trend-content">
                                            <h4 style={{ fontSize: "18px" }}>Thailand Honeymoon Package</h4>
                                            <div className="entry-meta d-flex align-items-center justify-content-between">
                                                <div className="entry-button d-flex align-items-center mb-2">
                                                    <a href="/packages/picturesque-phuket-krabi-couple-tour-package-in-budget" target="_blank" className="nir-btn2">View Package</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="container-fluid pb-4 pt-1">
                    <div class="container">
                        <div className="section-title mb-6 w-60 mx-auto text-center">
                            <h2 className="mb-1">Popular Sightseeing <span className="theme">in Thailand</span></h2>
                        ...
                        <div class="row">
                            <div class="col-sm-3 col-md-6 col-lg-3">
                                <div class="box">
                                    <div class="imgbox">
                                        <img src="/images/landing/Coral Island.webp" class="img-responsive" />
                                    </div>
                                    <div class="content">
                                        <h3>Coral Island <br />Tour</h3>
                                        <div class="col-lg-12">
                            ...
                            <div class="col-sm-3 col-md-6 col-lg-3">
                                <div class="box">
                                    <div class="imgbox">
                                        <img src="/images/landing/koh_hong.webp" class="img-responsive" />
                                    </div>
                                    <div class="content">
                                        <h3>Koh Hong</h3>
                                        <div class="col-lg-12 ">
                            ...
                            <div class="col-sm-3 col-md-6 col-lg-3">
                                <div class="box">
                                    <div class="imgbox">
                                        <img src="/images/landing/Phi phi island.webp" class="img-responsive" />
                                    </div>
                                    <div class="content">
                                        <h3>Phi Phi Island <br />Tour</h3>
                            ...
                            <div class="col-sm-3 col-md-6 col-lg-3">
                                <div class="box">
                                    <div class="imgbox">
                                        <img src="/images/landing/ko_phi_phi_don.webp" class="img-responsive" />
                                    </div>
                                    <div class="content">
                                        <h3>Ko Phi Phi<br />Don</h3>
                                        <div class="col-lg-8 viewOfferBtnContainer">
                                            <LandingModal buttonLabel="Send Enquiry" labelSize="12px" Left="-12px" Right="81px"></LandingModal>
                                        </div>
                                    </div>
            ...
            <div className='my-content'  >
                <div className='carouse_div animated.infinite'>
                    <div class="container">
                        <section class="trending pt-8 pb-2 discount-action pb-0" style={{ backgroundImage: "url(images/landing/thailandbannerresp.webp)", borderRadius: "10px" }}>
                            <div class="call-banner pb-10">
                                <div class="trend-content w-75 mx-auto text-center px-5 mb-0" style={{ position: "relative", top: "40px" }}>
                                    <h2 style={{ color: "white", fontSize: "25px" }}>Customise Your Thailand Package</h2>
            ...
            <div class="container resp">
                <section class="trending pt-8 pb-2 discount-action pb-0" style={{ backgroundImage: "url(images/landing/thailandbanner.webp)", borderRadius: "10px" }}>
                    <div class="call-banner pb-10">
                        <div class="trend-content w-75 mx-auto text-center px-5 mb-0" style={{ position: "relative", top: "40px" }}>
