...
export default function test() {
    ...
    const getAllPackages = async () => {
        try {
            const url = `https://backend.tripzygo.in/packages?page=${page}&sort=${sort.sort},${sort.order}&destination_search=Internationalsummer`;
    ...
    return (
        <div>
            <Head>
                <title>TripzyGo -International Summer Packages</title>
            ...
            <section className="breadcrumb-main pb-20 pt-14" style={{ backgroundImage: "url(/images/banner_images/International.jpg)" }}>
