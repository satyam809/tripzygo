...
import Router, { withRouter, useRouter } from 'next/router'; //add useRouter this line
...
export default function test() {
    ...
    const handleContact = async (e) => {
        try {
            axios.post(url, { name, email_id, country_code, phone_no, no_of_passengers, preferred_destination, date_of_travel });
        } catch (error) { }
    };
    ...
    return (
        <>
            <Head>
                <title>TripzyGo - Turkey Tour Package</title>
            ...
            {/* <section className="trending recent-articles pb-0 pt-2 "  >
                <div className="container delightfulContainer">
                    <div className="section-title mb-3 w-100 mx-auto text-center">
                        <h2 className="mb-1" style={{ fontSize: "35px" }}>8N / 9D Europe Tour Package : <span className="theme">Sale Offer Expiring Soon!</span></h2>
                    </div>

                </div>
            </section> */}
            <section class="search-banner landing_bannerturkey  align-items-center pt-5 pb-10">
                <div class="container">
                    <div class="search-banner-in">
                        <div class="row align-items-center">
                            <div class="col-lg-9 col-md-5">
                                <div class="section-title mb-10 text-lg-start text-center">
                                    <h1 class=" white">Turkey Tour Package</h1>
                                    <h4 class=" white">7N / 8D Turkey Tour Package </h4>
            ...
            <section className="trending recent-articles pb-4 pt-4 "  >
                <div className="container delightfulContainer">
                    <div className="section-title mb-6 w-75 mx-auto text-center">
                        <h2 className="mb-1">Best Selling <span className="theme">Turkey Tour Packages</span></h2>
                        <div>Take a look at our latest Turkey Packages!</div>
                    </div>
                    <div className="recent-articles-inner">
                        <div className="row">
                            <div className="col-lg-4 col-md-6">
                                <div className="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
                                    <div className="trend-image">
                                        <img src="/images/landing/family.jpg" />
                                    </div>
                                    <div className="trend-content-main p-4 pb-2">
                                        <div className="trend-content">
                                            <h4 style={{ fontSize: "18px" }}>Turkey Family Package</h4>
                                            <div className="entry-meta d-flex align-items-center justify-content-between">
                                                <div className="entry-button d-flex align-items-center mb-2">
                                                    <a href="/packages/customised-turkey-tour-package" target="_blank" className="nir-btn2">View Package</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
                                    <div className="trend-image">
                                        <img src="/images/landing/honeymoon.jpg" />
                                    </div>
                                    <div className="trend-content-main p-4 pb-2">
                                        <div className="trend-content">
                                            <h4 style={{ fontSize: "18px" }}>Turkey Honeymoon Package</h4>
                                            <div className="entry-meta d-flex align-items-center justify-content-between">
                                                <div className="entry-button d-flex align-items-center mb-2">
                                                    <a href="/packages/mesmerizing-turkey-tour-package-for-couple" target="_blank" className="nir-btn2">View Package</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="col-lg-4">
                                <div className="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
                                    <div className="trend-image">
                                        <img src="/images/landing/vacation.jpg" />
                                    </div>
                                    <div className="trend-content-main p-4 pb-2">
                                        <div className="trend-content">
                                            <h4 style={{ fontSize: "18px" }}>Turkey Holiday Package</h4>
                                            <div className="entry-meta d-flex align-items-center justify-content-between">
                                                <div className="entry-button d-flex align-items-center mb-2">
                                                    <a href="/packages/turkey-holiday-package-from-india" target="_blank" className="nir-btn2">View Package</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="row">
                                    ...
                                    <div className="why-us-item text-center p-4 py-5 border rounded bg-white">
                                        <div className="why-us-content">
                                            <div className="why-us-icon">
                                                <img src="images/web icons 32/customized-tour-packages.png" />
                                            </div><br />
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6 mb-4">
                                    <div className="why-us-item text-center p-4 py-5 border rounded bg-white">
                                        <div className="why-us-content">
                                            <div className="why-us-icon">
                                                <img src="images/web icons 32/budgeted-tours.png" />
                                            </div><br />
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6 mb-4">
                                    <div className="why-us-item text-center p-4 py-5 border rounded bg-white">
                                        <div className="why-us-content">
                                            <div className="why-us-icon">
                                                <img src="images/web icons 32/dedicated-support.png" />
                                            </div><br />
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6 mb-4">
                                    <div className="why-us-item text-center p-4 py-5 border rounded bg-white">
                                        <div className="why-us-content">
                                            <div className="why-us-icon">
                                                <img src="images/web icons 32/World-wide-touring.png" />
                                            </div><br />
            ...
            <section1>
                <div class="container-fluid pb-4 pt-1">
                    <div class="container">
                        <div className="section-title mb-6 w-60 mx-auto text-center">
                            <h2 className="mb-1">Best Places to Visit <span className="theme">in Turkey </span></h2>
                            <div>Explore the Best of Turkey!</div>
                        </div>
                        <div class="row">
                            <div class="col-sm-3 col-md-6 col-lg-3">
                                <div class="box">
                                    <div class="imgbox">
                                        <img src="/images/landing/istanbul.jpg" class="img-responsive" />
                                    </div>
                                    <div class="content">
                                        <h3>Istanbul</h3>
                                        <div class="col-lg-12">
                                            <LandingModal buttonLabel="Send Enquiry" labelSize="12px" Left="-15px" Right="15px"></LandingModal>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3 col-md-6 col-lg-3">
                                <div class="box">
                                    <div class="imgbox">
                                        <img src="/images/landing/cappadocia.jpg" class="img-responsive" />
                                    </div>
                                    <div class="content">
                                        <h3>Cappadocia</h3>
                                        <div class="col-lg-12 ">
                            ...
                            <div class="col-sm-3 col-md-6 col-lg-3">
                                <div class="box">
                                    <div class="imgbox">
                                        <img src="/images/landing/ankara.jpg" class="img-responsive" />
                                    </div>
                                    <div class="content">
                                        <h3>Ankara</h3>
                                        <div class="col-lg-8 viewOfferBtnContainer">
                                            <LandingModal buttonLabel="Send Enquiry" labelSize="12px" Left="-14px" Right="83px"></LandingModal>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-md-6 col-lg-3">
                                <div class="box">
                                    <div class="imgbox">
                                        <img src="/images/landing/antalya.jpg" class="img-responsive" />
                                    </div>
                                    <div class="content">
                                        <h3>Antalya</h3>
                                        <div class="col-lg-8 viewOfferBtnContainer">
                                            <LandingModal buttonLabel="Send Enquiry" labelSize="12px" Left="-12px" Right="81px"></LandingModal>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div className='my-content'  >
                <div className='carouse_div animated.infinite'>
                    <div class="container">
                        <section class="trending pt-8 pb-2 discount-action pb-0" style={{ backgroundImage: "url(images/landing/customized_turkey_mobile.jpg)", borderRadius: "10px" }}>
                            <div class="call-banner pb-10">
                                <div class="trend-content w-75 mx-auto text-center px-5 mb-0" style={{ position: "relative", top: "40px" }}>
                                    <h2 style={{ color: "white", fontSize: "25px" }}>Customise Your Turkey Honeymoon Package</h2>
            ...
            <div class="container resp">
                <section class="trending pt-8 pb-2 discount-action pb-0" style={{ backgroundImage: "url(images/landing/customized_turkey.jpg)", borderRadius: "10px" }}>
                    <div class="call-banner pb-10">
                        <div class="trend-content w-100 mx-auto text-center px-5 mb-0" style={{ position: "relative", top: "40px" }}>
                            <h2 style={{ color: "white" }}>Customise Your Turkey Honeymoon Package</h2>
                            <LandingModal buttonLabel="Customise Now!" labelSize="16px" top="0px" width="auto" ></LandingModal>
                        </div>
                    </div>
                </section>
            ...
            {/* <div class="container">
                <section class="trending pt-8 pb-2 discount-action pb-0" style={{ backgroundImage: "url(images/landing/thailandbanner.webp)", borderRadius: "10px", width: "100%", height: "auto" }}>
                    <div class="call-banner pb-10">
                        <div class="trend-content w-75 mx-auto text-center px-5 mb-0" style={{ position: "relative", top: "40px" }}>
                            <h2 style={{ color: "white" }}>Customise Your Thailand Package</h2>
                            <LandingModal buttonLabel="Customise Now!" labelSize="16px" top="0px" width="auto" ></LandingModal>
                        </div>
                    </div>
                </section>
