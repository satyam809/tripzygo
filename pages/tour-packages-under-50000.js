...
export async function getServerSideProps(){
    ...
    pData = pData.filter(pack => pack.web_pack_price >= 30001 && pack.web_pack_price <= 50000);
    console.log(pData);
    return {
        props: {
            pData,
...
export default function test({pData}) {
    ...
    return (
        <div>
            <Head>
                <title>Best-selling Tour Packages 𝗨𝗻𝗱𝗲𝗿 𝗜𝗡𝗥 𝟱𝟬𝗞</title>
                <meta name="description" content="Discover extraordinary journeys with our best-selling tour packages under INR 50K. Explore top destinations and create lasting memories. " />
                <link rel="icon" href="/icon.png" />

            </Head>
            {/* <HomeModal ImageLink="/images/popup/Winter.webp" alt="Winter Tour Packages" /> */}

            <section className="breadcrumb-main pb-6 pt-10" style={{ backgroundImage: "url(/images/banner_images/2.jpg)" }}>
                        ...
                        <div className="breadcrumb-content text-center">
                            <nav aria-label="breadcrumb" className="d-block">
                                <ul className="breadcrumb banner-content">
                                    ...
                                    <h1 className='text-white' id="tourPackagesHeading">Tour Packages Under 50k</h1><br />
