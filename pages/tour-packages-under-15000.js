...
export async function getServerSideProps(){
    ...
    // pData = pData.filter(pack => pack.web_pack_price >= 15000 && pack.web_pack_price <= 30000);
    console.log(pData);
    return {
        props: {
            pData,
...
export default function test({pData}) {
    ...
    return (
        <div>
            <Head>
                <title>Top selling Tour Packages 𝗨𝗻𝗱𝗲𝗿 𝗜𝗡𝗥 𝟭𝟱𝗞</title>
                <meta name="description" content="Unlock unparalleled travel experiences with our tour packages under INR 15K. Explore must-visit destinations for a journey that exceeds your expectations." />
                <link rel="icon" href="/icon.png" />

            </Head>
            {/* <HomeModal ImageLink="/images/popup/Winter.webp" alt="Winter Tour Packages" /> */}

            <section className="breadcrumb-main pb-6 pt-10" style={{ backgroundImage: "url(/images/banner_images/6.jpg)" }}>
                        ...
                        <div className="breadcrumb-content text-center">
                            <nav aria-label="breadcrumb" className="d-block">
                                <ul className="breadcrumb banner-content">
                                    ...
                                    <h1 className='text-white' id="tourPackagesHeading">Tour Packages Under 15k</h1><br />
