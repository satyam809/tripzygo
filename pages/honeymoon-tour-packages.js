...
export async function getServerSideProps(){
    ...
    pData = pData.filter(pack =>
        pack.destination_search.split(',').map(keyword => keyword.trim()).includes('Honeymoon')
        );
    console.log(pData);
    return {
        props: {
...
export default function test({pData}) {
    ...
    return (
        <div>
            <Head>
                <title>69 Honeymoon Tour Packages 𝗨𝗽𝘁𝗼 𝟱𝟬% 𝗢𝗳𝗳</title>
                <meta name="description" content="Embark on romance with our curated honeymoon tour packages. Explore the best enchanting destinations for an unforgettable journey of love and togetherness." />
                <link rel="icon" href="/icon.png" />

            </Head>
            {/* <HomeModal ImageLink="/images/popup/Winter.webp" alt="Winter Tour Packages" /> */}

            <section className="breadcrumb-main pb-6 pt-10" style={{ backgroundImage: "url(/images/banner_images/honeymoon.jpg)" }}>
                        ...
                        <div className="breadcrumb-content text-center">
                            <nav aria-label="breadcrumb" className="d-block">
                                <ul className="breadcrumb banner-content">
                                    ...
                                    <h1 className='text-white' id="tourPackagesHeading">Honeymoon Tour Packages</h1><br />
