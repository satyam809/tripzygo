...
export async function getServerSideProps(){
    ...
    pData = pData.filter(pack => pack.web_pack_price >= 50000 && pack.web_pack_price <= 75000);
    console.log(pData);
    return {
        props: {
            pData,
...
export default function test({pData}) {
    ...
    return (
        <div>
            <Head>
                <title>30 Tour Packages 𝗨𝗻𝗱𝗲𝗿 𝗜𝗡𝗥 𝟳𝟱𝗞 at TripzyGo</title>
                <meta name="description" content="Unlock your next adventure with our diverse range of 30 tour packages under 75K at TripzyGo. Tailored for every traveler, book your dream getaway with ease." />
                <link rel="icon" href="/icon.png" />

            </Head>
            {/* <HomeModal ImageLink="/images/popup/Winter.webp" alt="Winter Tour Packages" /> */}

            <section className="breadcrumb-main pb-6 pt-10" style={{ backgroundImage: "url(/images/banner_images/1.jpg)" }}>
                        ...
                        <div className="breadcrumb-content text-center">
                            <nav aria-label="breadcrumb" className="d-block">
                                <ul className="breadcrumb banner-content">
                                    ...
                                    <h1 className='text-white' id="tourPackagesHeading">Tour Packages Under 75k</h1><br />
