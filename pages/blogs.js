...
function App() {
    ...
    const getAllBlogs = async () => {
        try {
            const url = `${blogs_base_url}?page=${page}&sort=${sort.sort},${sort.order
                }&blog_category_filter=${blogCategory.toString()}`;
    ...
    return (
        <>
            ...
            <section class="breadcrumb-main pb-6 pt-10" style={{ backgroundImage: "url(images/banner_images/blog.webp)" }}>
