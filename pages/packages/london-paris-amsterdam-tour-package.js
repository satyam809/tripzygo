    ...
    return (
        <div>
            <Head>
                ...
                <title>TripzyGo - Book Your London Paris Amsterdam trip - Europe Tour Package </title>
                <meta name="description"
                    content="Looking for an amazing London Paris Amsterdam trip? We offer affordable London Paris Amsterdam tours in Europe tour package. Grab the deal. Book your trip now! " />
                <meta name="keywords"
                    content="London Paris Amsterdam trip, London Paris Amsterdam tours, London Paris Amsterdam Tour Package" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/london-paris-amsterdam-tour-package" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/london-paris-amsterdam-tour-package" />
                <meta property="og:title" content="Book Your London Paris Amsterdam trip - Europe Tour Package " />
                <meta property="og:description" content="Looking for an amazing London Paris Amsterdam trip? We offer affordable London Paris Amsterdam tours in Europe tour package. Grab the deal. Book your trip now!" />
                <meta property="og:image" content="https://www.tripzygo.in/images/international_packages/london_paris_amsterdam_tour_package_a_wholesome_trip_experience/1.webp" />
            </Head>
<ShareButton/>
<PopularityWidget packageCount="78" progressBarPercentage="80%"/>
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">London Paris Amsterdam Tour Package</h2>
                                    ...
                                    <div className="thumbnail-/images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/london_paris_amsterdam_tour_package_a_wholesome_trip_experience/1.webp" alt="London Paris Amsterdam Tour Package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/london_paris_amsterdam_tour_package_a_wholesome_trip_experience/2.webp" alt="London Paris Amsterdam Tour Package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/london_paris_amsterdam_tour_package_a_wholesome_trip_experience/3.webp" alt="London Paris Amsterdam Tour" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/london_paris_amsterdam_tour_package_a_wholesome_trip_experience/4.webp" alt="London Paris Amsterdam Tour" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/london_paris_amsterdam_tour_package_a_wholesome_trip_experience/5.webp" alt=" London Paris Amsterdam trip  " />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/london_paris_amsterdam_tour_package_a_wholesome_trip_experience/6.webp" alt=" London Paris Amsterdam trip " />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-12 col-md-6 mb-2 ">
                                            <div className="desc-box bg-grey p-4 rounded ">
                                                ...
                                                <div>What could be more wholesome than a trip to places full of art, culture, and romance.</div>
                                                <div class="mb-0">You can have one such exemplary experience on a London, Paris, Amsterdam trip.</div>
                                                <div>Have the most amazing time of your life with your family, friends, or partner with a wholesome experience on one of these London, Paris, Amsterdam tours that will take you to a whole world of leisure and luxury making you witness the rich culture and tradition of Britain in London, enjoy the romance that’s in the air of Paris, and learn the history along with noticing the beautiful arts and architectures in Amsterdam.</div>
                                                <div>With all of these things, a London, Paris, Amsterdam tour is a complete package that you don’t want to miss at all.</div>
                                                <div>So, book your London, Paris, Amsterdam tour package from India now and enjoy.</div>
                                            </div>
                                        </div>
                                    ...
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><i class="fa fa-inr pink mr-1" aria-hidden="true"></i> Total Tour Cost : INR 1,19,500/-*  </td>
