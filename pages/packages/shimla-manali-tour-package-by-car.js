    ...
    return (
        <div>
            <Head>
                ...
                <title>TripzyGo - Grab Exciting Shimla Manali Tour Package By Car From Delhi </title>
                ...
                <meta property="og:url" content="https://www.tripzygo.in/packages/shimla-manali-tour-package-by-car" />
                <meta property="og:title" content="TripzyGo - Grab Exciting Shimla Manali Tour Package By Car From Delhi " />
                ...
                <meta property="og:image" content="/images/domestic/shimla_manali_tour_package_by_car/1.webp" />

                <meta name="description" content="Looking for a Shimla Manali tour package from Delhi? Look no further than our exciting Shimla Manali tour package by car. Book this Shimla and Manali Package. " />
                <meta name="keywords" content="Shimla Manali tour package from Delhi, Shimla Manali tour package by car, Shimla and Manali package" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/shimla-manali-tour-package-by-car" />
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">Shimla Manali Tour Package By Car Ex- Delhi</h2>
                                    ...
                                    <div className="thumbnail-images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/domestic/shimla_manali_tour_package_by_car/1.webp" alt="Shimla Manali tour package from Delhi" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/domestic/shimla_manali_tour_package_by_car/2.webp" alt="Shimla Manali tour package from Delhi" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/domestic/shimla_manali_tour_package_by_car/3.webp" alt="Shimla Manali tour package by car" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/domestic/shimla_manali_tour_package_by_car/4.webp" alt="Shimla Manali tour package by car" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/domestic/shimla_manali_tour_package_by_car/5.webp" alt="Shimla and Manali package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/domestic/shimla_manali_tour_package_by_car/6.webp" alt="Shimla and Manali package" />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 mb-2 ">
                                            <div class="desc-box bg-grey p-4 rounded ">
                                                ...
                                                <div>Have you always wanted to have a road trip to Shimla and Manali? Well,this Shimla Manali tour package from Delhi is all you need to book.</div>
                                                <div class="mb-0">Starting from Delhi this Shimla Manali tour package is designed with a well planned itinerary to take you on the best paths to Shimla and Manali where you can witness both the hill stations in all their beauty and glamour with the view of picturesque mountains and enchanting landscapes.</div>
                                                <div class="mb-0">With stays at the most unique places in Shimla and Manali and travel through car throughout your journey, this Shimla Manali trip will be a wholesome experience that will add many memories and moments to your travel diaries.</div>
                                ...
                                <div class="tour-includes mb-4">
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td><i className="fa fa-clock-o pink mr-1" aria-hidden="true"></i> Package Category : Luxury</td>
                                            ...
                                            <tr>
                                                ...
                                                <td><i class="fa fa-inr pink mr-1" aria-hidden="true"></i> Total Tour Cost : INR 19,400/-*</td>
                                                        ...
                                                        <div className="row">
                                                            <div id="iternary" className="accrodion-grp faq-accrodion mb-4" data-grp-name="faq-accrodion" >
                                                                ...
                                                                <div className="accrodion">
                                                                    ...
                                                                    <div className="accrodion-content" style={{ display: "none" }} >
                                                                        <div className="inner">
                                                                            <div className="mb-0"> Some best picnic spots in Shimla are
                                                                                Annadale
                                                                                The Glen
                                                                                Indira Tourist Park
