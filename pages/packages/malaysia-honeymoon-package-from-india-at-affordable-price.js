    ...
    return (
        <div>
            <Head>
                ...
                <title>TripzyGo - Malaysia Honeymoon Package From India At An Affordable Price</title>
                <meta name="description" content="Malaysia honeymoon package from India at affordable price. Plan a honeymoon trip to Malaysia and find the best places to visit in Malaysia for couples. Book now." />
                <meta name="keywords" content="malaysia honeymoon package from india at affordable price, best places to visit in malaysia for couples, honeymoon trip to malaysia" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/malaysia-honeymoon-package-from-india-at-affordable-price" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/malaysia-honeymoon-package-from-india-at-affordable-price" />
                <meta property="og:title" content="Malaysia Honeymoon Package From India At An Affordable Price" />
                <meta property="og:description" content="Malaysia honeymoon package from India at affordable price. Plan a honeymoon trip to Malaysia and find the best places to visit in Malaysia for couples. Book now." />
                <meta property="og:image" content="https://www.tripzygo.in/images/international_packages/malaysia_honeymoon_package_from_india_at_affordable_price/1.webp" />
            </Head>
<ShareButton/>
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">Malaysia Honeymoon Package From India At Affordable Price</h2>
                                    ...
                                    <div className="thumbnail-/images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/malaysia_honeymoon_package_from_india_at_affordable_price/1.webp" alt="malaysia honeymoon package from india at affordable price" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/malaysia_honeymoon_package_from_india_at_affordable_price/2.webp" alt="malaysia honeymoon package from india at affordable price" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/malaysia_honeymoon_package_from_india_at_affordable_price/3.webp" alt=" best places to visit in malaysia for couples" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/malaysia_honeymoon_package_from_india_at_affordable_price/4.webp" alt="best places to visit in malaysia for couples " />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/malaysia_honeymoon_package_from_india_at_affordable_price/5.webp" alt="honeymoon trip to malaysia" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/malaysia_honeymoon_package_from_india_at_affordable_price/6.webp" alt="honeymoon trip to malaysia" />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 mb-2 ">
                                            <div class="desc-box bg-grey p-4 rounded ">
                                                ...
                                                <div>A honeymoon trip to Malaysia can be the most exciting and romantic getaway of your life.</div>
                                                <div class="mb-0">Malaysia is a beautiful land full of beaches and rainforests.</div>
                                                <div>You would be amazed and mesmerised by the places to visit in Malaysia for couples.</div>
                                                <div>You can go down for a walk on the romantic beaches or enjoy any adventurous activities to do on the beaches. </div>
                                                <div>You can go for an adventure in the rainforests, probably trekking and find your way closer to your partner.</div>
                                                <div>A visit to the colonial buildings and the shopping districts is also a great idea to spoil your partner with some amazing souvenirs from the beautiful island country.</div>
                                                <div>With so much to do around Malaysia, you’ll have an amazing time and at an affordable price.</div>
                                                <div>So, what are you waiting for? Book this amazing Malaysia honeymoon package from India at affordable price and go on the most amazing getaway with your partner.</div>
                                            </div>
                                        </div>
                                ...
                                <div class="tour-includes mb-4">
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><i class="fa fa-inr pink mr-1" aria-hidden="true"></i> Total Tour Cost : INR 12,700/-*  </td>
