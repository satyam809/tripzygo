    ...
    return (
        <div>
            <Head>
                ...
                <title>TripzyGo - Book Malaysia Holiday Package For Family - Family Trip To Malaysia</title>
                <meta name="description" content="Plan a family trip to Malaysia and explore the best place for a family vacation in Malaysia. Book our Malaysia holiday package for family and enjoy. Grab now!" />
                <meta name="keywords" content="malaysia tour packages from india for family, family package for malaysia, budget family vacation in malaysia" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/malaysia-holiday-package-for-family" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/malaysia-holiday-package-for-family" />
                <meta property="og:title" content="Book Malaysia Holiday Package For Family - Family Trip To Malaysia" />
                <meta property="og:description" content="Plan a family trip to Malaysia and explore the best place for a family vacation in Malaysia. Book our Malaysia holiday package for family and enjoy. Grab now!" />
                <meta property="og:image" content="https://www.tripzygo.in/images/international_packages/malaysia_holiday_package_for_family/1.webp" />
            </Head>
<ShareButton/>
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">Malaysia Holiday Package For Family</h2>
                                    ...
                                    <div className="thumbnail-/images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/malaysia_holiday_package_for_family/1.webp" alt="malaysia tour package at affordable price" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/malaysia_holiday_package_for_family/2.webp" alt="malaysia tour package at affordable price" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/malaysia_holiday_package_for_family/3.webp" alt=" budget trip to malaysia from india" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/malaysia_holiday_package_for_family/4.webp" alt="budget trip to malaysia from india " />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/malaysia_holiday_package_for_family/5.webp" alt="unique places to visit in malaysia" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/malaysia_holiday_package_for_family/6.webp" alt="unique places to visit in malaysia" />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 mb-2 ">
                                            <div class="desc-box bg-grey p-4 rounded ">
                                                ...
                                                <div>A family trip to Malaysia can be one of the most exciting experiences in your life.</div>
                                                <div class="mb-0">With exotic beaches, lush green rainforests, colonial buildings, huge shopping districts, Malaysia is a blend of fun and learning.</div>
                                                <div>You can learn from the multiple influences of the Malaysian, European, Indian, and Chinese cultures.</div>
                                                <div>At the same time you can just let lose and indulge in all the fun, excitement, and enjoyment that some activities at the beaches or adventures in the rainforests have to offer.</div>
                                                <div>With these opportunities, you don’t want to miss a chance to go on a family vacation to this amazing place, especially when you can book a Malaysia holiday package for family at such an affordable price.</div>
                                                <div>So, what are you waiting for? Pick your phones and get in touch now to discuss and book this amazing holiday for you and your family.</div>
                                            </div>
                                        </div>
