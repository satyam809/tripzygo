    ...
    return (
        <div>
            <Head>
                ...
                <title>TripzyGo - Trip To London And Paris With London Paris Holiday Package  </title>
                <meta name="description" content="Take a trip to London and Paris with our best London Paris holiday package. See the best of both cities with Paris London tour package. Book your trip today!" />
                <meta name="keywords" content="London Paris holiday package, Paris London tour package, trip to London and Paris" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/luxurious-london-paris-holiday-package" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/luxurious-london-paris-holiday-package" />
                <meta property="og:title" content="Trip To London And Paris With London Paris Holiday Package " />
                <meta property="og:description" content="Take a trip to London and Paris with our best London Paris holiday package. See the best of both cities with Paris London tour package. Book your trip today!" />
                <meta property="og:image" content="https://www.tripzygo.in/images/international_packages/london_paris_holiday_package_an_exciting_experience/1.webp" />
            </Head>
<ShareButton/>
<PopularityWidget packageCount="77" progressBarPercentage="77%"/>
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">Luxurious London Paris Holiday Package</h2>
                                    ...
                                    <div className="thumbnail-/images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/london_paris_holiday_package_an_exciting_experience/1.webp" alt=" London Paris holiday package " />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/london_paris_holiday_package_an_exciting_experience/2.webp" alt=" London Paris holiday package " />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/london_paris_holiday_package_an_exciting_experience/3.webp" alt=" Paris London tour package " />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/london_paris_holiday_package_an_exciting_experience/4.webp" alt="Paris London tour package  " />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/london_paris_holiday_package_an_exciting_experience/5.webp" alt="trip to London and Paris" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/london_paris_holiday_package_an_exciting_experience/6.webp" alt=" trip to London and Paris " />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 mb-2 ">
                                            <div class="desc-box bg-grey p-4 rounded ">
                                                ...
                                                <div>UK and France are amazing countries full of a plethora of things to offer.</div>
                                                <div class="mb-0">Whether it’s about romance or learning, UK and France are places with beautiful sites and ancient heritage. </div>
                                                <div>So, a trip to London and Paris would be great for anyone, whether couples, elderly, students, or family. </div>
                                                <div>Have a customised London Paris holiday package that will accommodate your needs and design a tour itinerary as per your requirements. </div>
                                                <div> Whether you wish to have romantic moments with your partner or seek to learn about UK and France’s amazing history, culture, literature, and art; we have everything designed in our Paris London tour package.</div>
                                                ...
                                                <div>Don’t wait up. Book this exciting journey now by getting in touch with a TripzyGo tour operator.</div>
                                            </div>
                                        </div>
                                    ...
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><i class="fa fa-inr pink mr-1" aria-hidden="true"></i> Total Tour Cost : INR 1,06,500/-*   </td>
