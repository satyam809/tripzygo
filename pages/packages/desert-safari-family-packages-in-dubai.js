...
export default function test() {
    ...
    return (
        <div>
            <Head>
                <title>TripzyGo - Desert Safari Family Packages In Dubai - Family Holiday To Dubai</title>
                <meta name="description" content="Explore the desert on quad bike with our desert safari family packages in Dubai. Enjoy desert life on your family trips to dubai. Book family holiday to Dubai." />
                <meta name="keywords" content="desert safari family packages in dubai, family trips to dubai, family holiday to dubai" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/desert-safari-family-packages-in-dubai" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/desert-safari-family-packages-in-dubai" />
                <meta property="og:title" content="Desert Safari Family Packages In Dubai - Family Holiday To Dubai" />
                <meta property="og:description" content="Explore the desert on quad bike with our desert safari family packages in Dubai. Enjoy desert life on your family trips to dubai. Book family holiday to Dubai." />
                <meta property="og:image" content="https://www.tripzygo.in/images/international_packages/desert_safari_family_packages_in_dubai/1.webp" />
            </Head>
<ShareButton/>
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">Desert Safari Family Packages In Dubai</h2>
                                    ...
                                    <div className="thumbnail-images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/desert_safari_family_packages_in_dubai/1.webp" alt="desert safari family packages in dubai" />

                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/desert_safari_family_packages_in_dubai/2.webp" alt="desert safari family packages in dubai" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/desert_safari_family_packages_in_dubai/3.webp" alt="family trips to dubai" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/desert_safari_family_packages_in_dubai/4.webp" alt="family trips to dubai" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/desert_safari_family_packages_in_dubai/5.webp" alt="family holiday to dubai" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/desert_safari_family_packages_in_dubai/6.webp" alt="family holiday to dubai" />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 mb-2 ">
                                            <div class="desc-box bg-grey p-4 rounded ">
                                                ...
                                                <div>A desert safari in Dubai is an experience of a lifetime.</div>
                                                <div class="mb-0">Now imagine going to Dubai exclusively for this experience.</div>
                                                <div>Doesn’t that feel magical?</div>
                                                <div>Dubai is a beautiful place where you can have a lot of fun with your family, especially when you are planning a desert safari with them.</div>
                                                <div>Have the most amazing family vacation with a family holiday to Dubai planned with the best Dubai itinerary including desert safari, amazing lunches, and time at Burj Khalifa.</div>
                                                <div>We are experts at planning family trips to Dubai and this desert safari experience will be one of a kind.</div>
                                                <div>Book the most amazing trip to Dubai with our amazing desert safari family packages in Dubai.</div>
                                                <div>Get in touch with us now to plan and book the experience.</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tour-includes mb-4">
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><i class="fa fa-inr pink mr-1" aria-hidden="true"></i> Total Tour Cost : INR 27,000/-*     </td>
