    ...
    return (
        <div>
            <Head>
                ...
                <title>TripzyGo - Bangkok Pattaya Tour in Budget For Cheap Trip To Bangkok Pattaya</title>
                <meta name="description" content="Book Bangkok Pattaya tour in budget with our amazing Bangkok Pattaya travel package from India. Specially for you to go on the cheap trip to bangkok pattaya." />
                <meta name="keywords" content="bangkok pattaya tour in budget, cheap trip to bangkok pattaya, bangkok pattaya travel package from india" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/breathtaking-bangkok-pattaya-tour-in-budget" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/breathtaking-bangkok-pattaya-tour-in-budget" />
                <meta property="og:title" content="Bangkok Pattaya Tour in Budget For Cheap Trip To Bangkok Pattaya" />
                <meta property="og:description" content="Book Bangkok Pattaya tour in budget with our amazing Bangkok Pattaya travel package from India. Specially for you to go on the cheap trip to bangkok pattaya." />
                <meta property="og:image" content="https://www.tripzygo.in/images/international_packages/breathtaking_bangkok_pattaya_tour_in_budget/2.webp" />
            </Head>
<ShareButton/>
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">Breathtaking Bangkok Pattaya Tour In Budget</h2>
                                    ...
                                    <div className="thumbnail-images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/breathtaking_bangkok_pattaya_tour_in_budget/1.webp" alt="bangkok pattaya tour in budget" />

                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/breathtaking_bangkok_pattaya_tour_in_budget/2.webp" alt="bangkok pattaya tour in budget" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/breathtaking_bangkok_pattaya_tour_in_budget/3.webp" alt="cheap trip to bangkok pattaya" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/breathtaking_bangkok_pattaya_tour_in_budget/4.webp" alt="cheap trip to bangkok pattaya" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/breathtaking_bangkok_pattaya_tour_in_budget/5.webp" alt="bangkok pattaya travel package from india" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/breathtaking_bangkok_pattaya_tour_in_budget/6.webp" alt="bangkok pattaya travel package from india" />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-12 col-md-6 mb-2 ">
                                            <div className="desc-box bg-grey p-4 rounded ">
                                                ...
                                                <div>Bangkok and Pattaya are amazing destinations to let loose and enjoy some stunning and cheerful times of your life.</div>
                                                <div class="mb-0">This Bangkok Pattaya travel package from India will take you to the most stunning and fantastic Bangkok Pattaya trip of your life.</div>
                                                <div>Tight on budget? That will not be a problem at all because this amazing package is designed for a cheap trip to Bangkok Pattaya.</div>
                                                <div>Relax on the beaches, go on a shopping spree, do anything that your heart desires at these amazing destinations.</div>
                                                <div>Don’t wait up. Book this amazing package and enjoy the most breathtaking Bangkok Pattaya tour in budget.</div>
                                            </div>
                                        </div>
                                ...
                                <div className="tour-includes mb-4">
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><i class="fa fa-inr pink mr-1" aria-hidden="true"></i> Total Tour Cost : INR 19,950/- *   </td>
