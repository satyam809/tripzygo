    ...
    return (
        <div>
            <Head>
                ...
                <title>TripzyGo - France and Switzerland Honeymoon Tour Package - Paris And Zurich </title>
                <meta name="description" content="Celebrate your love with a France and Switzerland honeymoon package - Plan a romantic France Switzerland tour.
                            Book your Paris Switzerland tour package with us." />
                <meta name="keywords" content="France and Switzerland honeymoon package, France Switzerland tour, Paris Switzerland tour package" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/france-and-switzerland-honeymoon-package" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/france-and-switzerland-honeymoon-package" />
                <meta property="og:title" content="France and Switzerland Honeymoon Tour Package - Paris And Zurich " />
                <meta property="og:description" content="Celebrate your love with a France and Switzerland honeymoon package - Plan a romantic France Switzerland tour.
                            Book your Paris Switzerland tour package with us." />
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">France and Switzerland Honeymoon Package</h2>
                                    ...
                                    <div className="thumbnail-///images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/france_and_switzerland_honeymoon_package/1.webp" alt="france and switzerland honeymoon package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/france_and_switzerland_honeymoon_package/2.webp" alt="france and switzerland honeymoon package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/france_and_switzerland_honeymoon_package/3.webp" alt="France Switzerland tour" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/france_and_switzerland_honeymoon_package/4.webp" alt="France Switzerland tour" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/france_and_switzerland_honeymoon_package/5.webp" alt="Paris Switzerland tour package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/france_and_switzerland_honeymoon_package/6.webp" alt="Paris Switzerland tour package" />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
