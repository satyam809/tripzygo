    ...
    return (
        <div>
            <Head>
                ...
                <title>TripzyGo - Phuket Krabi Tour Package in Budget</title>
                <meta name="description" content="Want to get Phuket Krabi tour package in budget? Book our Phuket Krabi trip package to save your pockets. Enjoy your trip to Phuket and Krabi hassle-free." />
                <meta name="keywords" content="phuket krabi tour package in budget, phuket krabi trip package, trip to phuket and krabi" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/phuket-krabi-tour-package-in-budget" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/phuket-krabi-tour-package-in-budget" />
                <meta property="og:title" content="Phuket Krabi Tour Package in Budget" />
                <meta property="og:description" content="Want to get Phuket Krabi tour package in budget? Book our Phuket Krabi trip package to save your pockets. Enjoy your trip to Phuket and Krabi hassle-free." />
                <meta property="og:image" content="https://www.tripzygo.in/images/international_packages/peaceful_phuket_krabi_holiday_package/1.webp" />
            </Head>
<ShareButton/>
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">Phuket Krabi Tour Package in Budget</h2>
                                    ...
                                    <div className="thumbnail-images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/peaceful_phuket_krabi_holiday_package/1.webp" alt="phuket krabi holiday package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/peaceful_phuket_krabi_holiday_package/2.webp" alt="phuket krabi holiday package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/peaceful_phuket_krabi_holiday_package/3.webp" alt="holiday package to phuket krabi" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/peaceful_phuket_krabi_holiday_package/4.webp" alt="holiday package to phuket krabi" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/peaceful_phuket_krabi_holiday_package/5.webp" alt="trip to phuket and krabi" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/peaceful_phuket_krabi_holiday_package/6.webp" alt="trip to phuket and krabi" />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 mb-2 ">
                                            <div class="desc-box bg-grey p-4 rounded ">
                                                ...
                                                <div>Thinking of a budget trip to Phuket Krabi? Well, this tour package is designed just for you.</div>
                                                <div class="mb-0">This phuket krabi holiday package takes into its tour itinerary some of the best experiences to enjoy in Phuket and Krabi such as a Krabi four island tour, Phi Phi island tour, Phuket city tour and more.</div>
                                                <div>You will be amused to enjoy all these experiences in such a beautiful city on a very budgeted price.</div>
                                                <div>This will be the best tour of your life where you will not turn out your pocket of all the money in them and have the most fun experiences while spending in a budget.</div>
                                                <div>So, don’t wait up. Book this amazing experience for yourself by booking this amazing holiday package to phuket krabi that will take you to the best places in Phuket and Krabi within your budget.</div>
                                                <div>Get in touch with us now.</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tour-includes mb-4">
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><i class="fa fa-inr pink mr-1" aria-hidden="true"></i> Total Tour Cost : INR 21,500/-* </td>
