    ...
    return (
        <div>
            <Head>
                ...
                <title>TripzyGo - Phuket Krabi Holiday Package with Phuket Krabi 6 Days Itinerary</title>
                <meta name="description" content="Book the most amazing Phuket Krabi holiday package and have the best Phuket Krabi 6 days itinerary. Book your holiday package to Phuket Krabi now." />
                <meta name="keywords" content="phuket krabi holiday package, holiday package to phuket krabi, phuket krabi 6 days itinerary" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/peaceful-phuket-krabi-holiday-package" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/peaceful-phuket-krabi-holiday-package" />
                <meta property="og:title" content="Phuket Krabi Holiday Package with Phuket Krabi 6 Days Itinerary" />
                <meta property="og:description" content="Book the most amazing Phuket Krabi holiday package and have the best Phuket Krabi 6 days itinerary. Book your holiday package to Phuket Krabi now." />
                <meta property="og:image" content="https://www.tripzygo.in/images/international_packages/phuket_krabi_tour_package_in_budget/1.webp" />
            </Head>
<ShareButton/>
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">Peaceful Phuket Krabi Holiday Package</h2>
                                    ...
                                    <div className="thumbnail-images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/phuket_krabi_tour_package_in_budget/1.webp" alt="phuket krabi tour package in budget" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/phuket_krabi_tour_package_in_budget/2.webp" alt="phuket krabi tour package in budget" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/phuket_krabi_tour_package_in_budget/3.webp" alt="phuket krabi trip package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/phuket_krabi_tour_package_in_budget/4.webp" alt="phuket krabi trip package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/phuket_krabi_tour_package_in_budget/5.webp" alt="trip to phuket and krabi" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/phuket_krabi_tour_package_in_budget/6.webp" alt="trip to phuket and krabi" />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 mb-2 ">
                                            <div class="desc-box bg-grey p-4 rounded ">
                                                ...
                                                <div>Thinking of a holiday in Phuket Krabi? </div>
                                                <div class="mb-0">Well, that’s an amazing idea and it will become all the more happening, exciting, and fun with this amazing Phuket Krabi holiday package designed for absolute comfort, luxury, and enjoyment in these amazing island countries.</div>
                                                <div>Have the most amazing time on the islands of Phuket and Krabi with this amazing Phuket Krabi 6 days itinerary specially designed and customised to offer you the most wonderful experiences in these island nations.</div>
                                                <div>Be it having a relaxing time at the beaches or enjoying an amazing lunch or dinner trying different and new cuisines, or indulging in different activities on the beaches and other amazing places in Phuket and Krabi, this Phuket Krabi holiday package includes everything.</div>
                                                <div>So, don’t wait up. Have the most amazing holidays in the most exciting places by booking this amazing holiday package to Phuket Krabi.</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div id="iternary" class="accrodion-grp faq-accrodion mb-4" data-grp-name="faq-accrodion" >
                                            ...
                                            <div class="accrodion ">
                                                ...
                                                <div class="accrodion-content" style={{ display: "none" }}>
                                                    <div class="inner">
                                                        <div class="mb-0"><i class="fa fa-arrow-right" aria-hidden="true" style={{ fontSize: "13px" }}></i> On day 2 of your Phuket and Krabi tour, savor a hearty breakfast and get ready for an enthralling four island tour, Krabi is famous for.</div>
                                            ...
                                            <div class="accrodion">
                                                <div class="accrodion-title rounded">
                                                    <h5 class="mb-0"><span>Day 3</span>  –  Krabi - Phuket (Day at leisure) </h5>
                                                </div>
                                                <div class="accrodion-content" style={{ display: "none" }}>
                                                    <div class="inner">
                                                        ...
                                                        <div class="mb-0"><i class="fa fa-arrow-right" aria-hidden="true" style={{ fontSize: "13px" }}></i> Reckoned as one of the world's finest beach destinations, Phuket is dotted with swaying palm trees, fine white sands, inviting beaches, lively towns and sparkling seas. </div>
                                                        <div class="mb-0"><i class="fa fa-arrow-right" aria-hidden="true" style={{ fontSize: "13px" }}></i> The beautiful archipelago has so many things to flaunt and make one fall in love instantly.</div>
                                                        <div class="mb-0"><i class="fa fa-arrow-right" aria-hidden="true" style={{ fontSize: "13px" }}></i> Go out to explore the surroundings on your own or simply take a leisurely walk around.</div>
                                                        <div class="mb-0"><i class="fa fa-arrow-right" aria-hidden="true" style={{ fontSize: "13px" }}></i> Enjoy an overnight stay at the hotel. </div>
                                            ...
                                            <div class="accrodion">
                                                <div class="accrodion-title rounded">
                                                    <h5 class="mb-0"><span>Day 4</span>  – Phuket – Phi Phi Island </h5>
                                                </div>
                                                <div class="accrodion-content" style={{ display: "none" }}>
                                                    <div class="inner">
                                            ...
                                            <div class="accrodion ">
                                                <div class="accrodion-title rounded">
                                                    <h5 class="mb-0"><span>Day 5</span> - Phuket City Tour </h5>
                                                </div>
                                                <div class="accrodion-content" style={{ display: "none" }}>
                                                    <div class="inner">
                                                        <div class="mb-0"><i class="fa fa-arrow-right" aria-hidden="true" style={{ fontSize: "13px" }}></i> Post having your breakfast, get ready for a guided tour of Phuket. </div>
                                                        ...
                                                        <div class="mb-0"><i class="fa fa-arrow-right" aria-hidden="true" style={{ fontSize: "13px" }}></i> Counted as the most important of the 29 Buddhist Temples in Phuket, the shrine boast of rich history.</div>
                                                        <div class="mb-0"><i class="fa fa-arrow-right" aria-hidden="true" style={{ fontSize: "13px" }}></i> When here, don't forget to witness the 60 meters tall stupa (chedi) protecting a bone fragment of Lord Buddha. Subsequently, you will visit Rawai Beach.</div>
                                                        ...
                                                        <div class="mb-0"><i class="fa fa-arrow-right" aria-hidden="true" style={{ fontSize: "13px" }}></i> Delight in a comfortable overnight stay at the hotel. </div>
                                            ...
                                            <div class="accrodion ">
                                                ...
                                                <div class="accrodion-content" style={{ display: "none" }}>
                                                    <div class="inner">
                                                        <div class="mb-0"><i class="fa fa-arrow-right" aria-hidden="true" style={{ fontSize: "13px" }}></i> After Breakfast get ready for you journey back to home . </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-12 col-md-6 mb-2">
                                            <div class="desc-box bg-grey p-4 rounded">
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="d-block "><i class="fa fa-check pink mr-1"></i> Phuket Hotel to Phuekt  Airport </li>
                                                    <li class="d-block "><i class="fa fa-check pink mr-1"></i> Krabi four island tour with lunch on sic basis </li>
                                                    <li class="d-block "><i class="fa fa-check pink mr-1"></i> Phi phi island tour with lunch on sic basis </li>
                                                    <li class="d-block "><i class="fa fa-check pink mr-1"></i> Phuket city tour on private basis </li>
