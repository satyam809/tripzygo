    ...
    return (
        <div>
            <Head>
                ...
                <title>TripzyGo - Book India To Bangkok Pattaya Tour Package - Bangkok And Pattaya Trip</title>
                <meta name="description" content="Book India to Bangkok Pattaya tour package to go on an amazing Bangkok and Pattaya trip. Enjoy your vacation with an exciting Bangkok Pattaya trip package." />
                <meta name="keywords" content="india to bangkok pattaya tour package, bangkok pattaya trip package, bangkok and pattaya trip" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/splendid-india-to-bangkok-pattaya-tour-package" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/splendid-india-to-bangkok-pattaya-tour-package" />
                <meta property="og:title" content="Book India To Bangkok Pattaya Tour Package - Bangkok And Pattaya Trip" />
                <meta property="og:description" content="Book India to Bangkok Pattaya tour package to go on an amazing Bangkok and Pattaya trip. Enjoy your vacation with an exciting Bangkok Pattaya trip package." />
                <meta property="og:image" content="https://www.tripzygo.in/images/international_packages/splendid_india_to_bangkok_pattaya_tour_package/1.webp" />
            </Head>
<ShareButton/>
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">Splendid India To Bangkok Pattaya Tour Package</h2>
                                    ...
                                    <div className="thumbnail-images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/splendid_india_to_bangkok_pattaya_tour_package/1.webp" alt="india to bangkok pattaya tour package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/splendid_india_to_bangkok_pattaya_tour_package/2.webp" alt="india to bangkok pattaya tour package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/splendid_india_to_bangkok_pattaya_tour_package/3.webp" alt="bangkok pattaya trip package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/splendid_india_to_bangkok_pattaya_tour_package/4.webp" alt="bangkok pattaya trip package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/splendid_india_to_bangkok_pattaya_tour_package/5.webp" alt="bangkok and pattaya trip" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/splendid_india_to_bangkok_pattaya_tour_package/6.webp" alt="bangkok and pattaya trip" />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 mb-2 ">
                                            <div class="desc-box bg-grey p-4 rounded ">
                                                ...
                                                <div>Thinking of a Bangkok Pattaya trip? Well, who wouldn’t want to let loose in the splendid and frank environment of these amazing destinations.</div>
                                                <div class="mb-0">A tour to Bangkok Pattaya is indeed a travel goal especially when you are looking for sheer fun and entertainment.</div>
                                                <div>Have it all with this splendid India to Bangkok Pattaya tour package.</div>
                                                <div>Be it relaxing on the beaches, moving through the shops, or enjoying the stunning night life of these places, you can have everything on your tour and enjoy the most amazing time of your life.</div>
                                                <div>Don’t miss your chance to let loose in destinations as cool and amazing as Bangkok Pattaya.</div>
                                                <div>Book the Bangkok Pattaya trip package now by getting in touch with us.</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tour-includes mb-4">
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><i class="fa fa-inr pink mr-1" aria-hidden="true"></i> Total Tour Cost : INR 22,300/-*   </td>
