    ...
    return (
        <div>
            <Head>
                ...
                <title>TripzyGo - Romantic Bangkok Pattaya Trip Package For Couple - Bangkok Pattaya Itinerary 6 Days</title>
                <meta name="description" content="Special deal on Bangkok Pattaya trip package for couple with the best Bangkok Pattaya itinerary 6 days. Book your honeymoon couple trip to bangkok pattaya now." />
                <meta name="keywords" content="bangkok pattaya trip package for couple, couple trip to bangkok pattaya, bangkok pattaya itinerary 6 days" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/delightful-bangkok-pattaya-trip-package-for-couple" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/delightful-bangkok-pattaya-trip-package-for-couple" />
                <meta property="og:title" content="Romantic Bangkok Pattaya Trip Package For Couple - Bangkok Pattaya Itinerary 6 Days" />
                <meta property="og:description" content="Special deal on Bangkok Pattaya trip package for couple with the best Bangkok Pattaya itinerary 6 days. Book your honeymoon couple trip to bangkok pattaya now." />
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">Delightful Bangkok Pattaya Trip Package For Couple</h2>
                                    ...
                                    <div className="thumbnail-images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/delightful_malaysia_honeymoon_tour_from_india/1.webp" alt="bangkok pattaya trip package for couple" />

                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/delightful_malaysia_honeymoon_tour_from_india/2.webp" alt="bangkok pattaya trip package for couple" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/delightful_malaysia_honeymoon_tour_from_india/3.webp" alt="couple trip to bangkok pattaya" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/delightful_malaysia_honeymoon_tour_from_india/4.webp" alt="couple trip to bangkok pattaya" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/delightful_malaysia_honeymoon_tour_from_india/5.webp" alt="bangkok pattaya itinerary 6 days" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/delightful_malaysia_honeymoon_tour_from_india/6.webp" alt="bangkok pattaya itinerary 6 days" />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 mb-2 ">
                                            <div class="desc-box bg-grey p-4 rounded ">
                                                ...
                                                <div>Thinking of a couple trip to Bangkok Pattaya? Well, there could be nothing better than having sheer fun and enjoyment while exploring the amazing nightlife of these destinations with your partner.</div>
                                                <div class="mb-0">These places are frank and utterly romantic and you can have absolute moments of bliss and romance with your partner wherever you are in Bangkok and Pattaya.                                        </div>
                                                <div>Enjoy and chill at the beaches, romance on the streets while enjoying the nightlife, have fun at the islands, or do anything that your and your partner’s heart desires when you are in a place as amazing and beautiful as Bangkok and Pattaya.</div>
                                                <div>Have the most amazing time of your life on an amazing tour.</div>
                                                <div>Book the Bangkok Pattaya trip package for couple now.</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
