    ...
    return (
        <div>
            <Head>
                ...
                <title>TripzyGo - Phuket Krabi Tour Package for 6 Days - Tour to Phuket Krabi</title>
                <meta name="description" content="Escape to an island with Phuket Krabi tour package for 6 days. Enjoy Phuket Krabi holidays and have the most memorable time. Book your tour to Phuket Krabi now." />
                <meta name="keywords" content="phuket krabi tour package for 6 days, phuket krabi holidays, tour to phuket krabi" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/phuket-krabi-tour-package-for-six-days" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/phuket-krabi-tour-package-for-six-days" />
                <meta property="og:title" content="Phuket Krabi Tour Package for 6 Days - Tour to Phuket Krabi" />
                <meta property="og:description" content="Escape to an island with Phuket Krabi tour package for 6 days. Enjoy Phuket Krabi holidays and have the most memorable time. Book your tour to Phuket Krabi now." />
                <meta property="og:image" content="https://www.tripzygo.in/images/international_packages/phuket_krabi_tour_package_for_6_days/1.webp" />
            </Head>
<ShareButton/>
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">Phuket Krabi Tour Package For 6 Days</h2>
                                    ...
                                    <div className="thumbnail-images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/phuket_krabi_tour_package_for_6_days/1.webp" alt="phuket krabi tour package for 6 days" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/phuket_krabi_tour_package_for_6_days/2.webp" alt="phuket krabi tour package for 6 days" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/phuket_krabi_tour_package_for_6_days/3.webp" alt="phuket krabi holidays" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/phuket_krabi_tour_package_for_6_days/4.webp" alt="phuket krabi holidays" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/phuket_krabi_tour_package_for_6_days/5.webp" alt="trip to phuket krabi" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/phuket_krabi_tour_package_for_6_days/6.webp" alt="trip to phuket krabi" />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 mb-2 ">
                                            <div class="desc-box bg-grey p-4 rounded ">
                                                ...
                                                <div>Thinking of a tour to Phuket Krabi? Phuket Krabi holidays can indeed be very refreshing with amazing and exciting time at the islands.</div>
                                                <div class="mb-0">Be it a city tour of Phuket, a Krabi four islands tour, or a mesmerizing time at the Phi Phi islands, Phuket and Krabi have got a lot in store for you and can offer the best holiday experiences of all times.</div>
                                                <div>Have a chance to indulge in these amazing experiences by booking this wonderful Phuket Krabi tour package for 6 days.</div>
                                                <div>This package is designed and customized for 6 days of pure fun and entertainment and you will have the best time of your life on this budget tour.</div>
                                                <div>Book the tour package now by getting in touch with a TripzyGo travel specialist.</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
