    ...
    return (
        <div>
            <Head>
                ...
                <title>TripzyGo - Travel To Bangkok And Pattaya With Best Bangkok Pattaya Tour</title>
                <meta name="description" content="Finding a Bangkok Pattaya tour? Book our Bangkok Pattaya tour package from India. Explore the best of Thailand on your travel to Bangkok and Pattaya. Book now!" />
                <meta name="keywords" content="Bangkok Pattaya tour, Bangkok Pattaya tour package from India, travel to Bangkok and Pattaya" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/budget-bangkok-pattaya-tour" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/budget-bangkok-pattaya-tour" />
                <meta property="og:title" content="Travel To Bangkok And Pattaya With Best Bangkok Pattaya Tour" />
                <meta property="og:description" content="Finding a Bangkok Pattaya tour? Book our Bangkok Pattaya tour package from India. Explore the best of Thailand on your travel to Bangkok and Pattaya. Book now!" />
                <meta property="og:image" content="https://www.tripzygo.in/images/international_packages/budget_bangkok_pattaya_tour\1.webp" />
            </Head>
<ShareButton/>
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">Budget Bangkok Pattaya Tour</h2>
                                    ...
                                    <div className="thumbnail-images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/budget_bangkok_pattaya_tour\1.webp" alt="Bangkok Pattaya tour" />

                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/budget_bangkok_pattaya_tour\2.webp" alt="Bangkok Pattaya tour" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/budget_bangkok_pattaya_tour\3.webp" alt="Bangkok Pattaya tour package from India" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/budget_bangkok_pattaya_tour\4.webp" alt="Bangkok Pattaya tour package from India" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/budget_bangkok_pattaya_tour\5.webp" alt="travel to Bangkok and Pattaya" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/budget_bangkok_pattaya_tour\6.webp" alt="travel to Bangkok and Pattaya" />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 mb-2 ">
                                            <div class="desc-box bg-grey p-4 rounded ">
                                                ...
                                                <div>When you talk about a bachelor party or a fun trip with no restrictions whatsoever, places like Bangkok and Pattaya directly surface your mind. </div>
                                                <div class="mb-0"> A Bangkok Pattaya tour is a dream for many as it offers an amazing opportunity to have fun amidst the openness and frankness of the city.</div>
                                                <div>Be it the exciting activities or just some time at the beaches, bars, salons, or spas, Bangkok and Pattaya are the hotspot for all kinds of fun activities to enjoy and cherish.</div>
                                                <div>Don’t miss out this chance, especially when we have got the most amazing Bangkok Pattaya tour package from India for you to comfortably travel to Bangkok and Pattaya.</div>
                                                <div>Book the Bangkok Pattaya tour now by getting in touch with a TripzyGo travel specialist.</div>
                                            </div>
                                        </div>
                                ...
                                <div class="tour-includes mb-4">
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><i class="fa fa-inr pink mr-1" aria-hidden="true"></i> Total Tour Cost : INR 13,000/-* </td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-6 mb-2">
                                            <div class="desc-box bg-grey p-4 rounded">
                                                ...
                                                <ul>
                                                    <li class="d-block "><i class="fa fa-check pink mr-1"></i> 04 nights’ accommodation at the mentioned hotel inclusive of buffet breakfast</li>
                                                    <li class="d-block "><i class="fa fa-check pink mr-1"></i> current applicable taxes& service charges</li>
                                                    <li class="d-block "><i class="fa fa-check pink mr-1"></i> Transfers from Bangkok Airport to Pattaya  Hotel SIC</li>
                                                    <li class="d-block "><i class="fa fa-check pink mr-1"></i> Basis//Pattaya  Hotel to Bangkok Hotel  Bangkok Hotel To Bangkok </li>
                                                    <li class="d-block "><i class="fa fa-check pink mr-1"></i> Airport SIC Basis Dubai city tour</li>
