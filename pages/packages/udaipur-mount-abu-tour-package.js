    ...
    return (
        <div>
            <Head>
                ...
                <title>TripzyGo - 5 Days Udaipur Mount Abu Tour Package For your Next Trip</title>
                <meta name="description" content="Plan a Udaipur Mount Abu trip. Our 5 Days Udaipur Mount Abu Tour Package with the best itinerary will give you the best experience possible. Book the tour now." />
                <meta name="keywords" content="Udaipur Mount Abu Tour Package, Udaipur Mount Abu trip, udaipur and mount abu itinerary" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/udaipur-mount-abu-tour-package" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/udaipur-mount-abu-tour-package" />
                <meta property="og:title" content="5 Days Udaipur Mount Abu Tour Package For your Next Trip" />
                <meta property="og:description" content="Plan a Udaipur Mount Abu trip. Our 5 Days Udaipur Mount Abu Tour Package with the best itinerary will give you the best experience possible. Book the tour now." />
                <meta property="og:image" content="https://www.tripzygo.in/images/domestic/udaipur_mount_abu_tour_package/6.webp" />
            </Head>
<ShareButton/>
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">Udaipur Mount Abu Tour Package</h2>
                                    ...
                                    <div className="thumbnail-images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/domestic/udaipur_mount_abu_tour_package/6.webp" alt="udaipur and mount abu itinerary" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/domestic/udaipur_mount_abu_tour_package/1.webp" alt="Udaipur Mount Abu Tour Package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/domestic/udaipur_mount_abu_tour_package/2.webp" alt="Udaipur Mount Abu Tour Package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/domestic/udaipur_mount_abu_tour_package/3.webp" alt="Udaipur Mount Abu trip" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/domestic/udaipur_mount_abu_tour_package/4.webp" alt="Udaipur Mount Abu trip" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/domestic/udaipur_mount_abu_tour_package/5.webp" alt="udaipur and mount abu itinerary" />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 mb-2 ">
                                            <div class="desc-box bg-grey p-4 rounded ">
                                                ...
                                                <div>A Udaipur Mount Abu Trip is on everyone’s mind. Who wouldn’t want to escape into the enchantingly beautiful lakes and mountains after all?</div>
                                                <div class="mb-0">This Udaipur Mount Abu Tour Package is to fulfil your dream of having the best touring experience of your life on an exciting trip to the city of lakes and the hills of wisdom</div>
                                                <div>Covering the forts and lakes of Udaipur and the picturesque landscapes of Mount Abu, this Udaipur Mount Abu tour package is designed to offer you the best itinerary on your trip, an experience you will never forget.</div>
                                                <div>Book your tour package now and enroute a wonderful experience that’s waiting for you in the form of a Udaipur Mount Abu trip. </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="accrodion">
                                                ...
                                                <div class="accrodion-content" style={{ display: "none" }}>
                                                    <div class="inner">
                                                        ...
                                                        <div class="mb-0"><i class="fa fa-arrow-right" aria-hidden="true" style={{ fontSize: "13px" }}></i> On arrival check into the hotel. </div>
                                            ...
                                            <div class="accrodion ">
                                                ...
                                                <div class="accrodion-content" style={{ display: "none" }}>
                                                    <div class="inner">
                                                        ...
                                                        <div class="mb-0"><i class="fa fa-arrow-right" aria-hidden="true" style={{ fontSize: "13px" }}></i> Evening free to Explore Local Market by Own. Overnight stay at Hotel.</div>
                                        ...
                                        <div class="col-lg-12 col-md-6 mb-2">
                                            <div class="desc-box bg-grey p-4 rounded">
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="d-block"><i class="fa fa-check pink mr-1"></i> All toll taxes, parking fees, Fuel and driver's allowances</li>
