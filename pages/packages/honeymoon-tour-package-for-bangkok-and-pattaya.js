    ...
    return (
        <div>
            <Head>
                ...
                <title>TripzyGo - Get Your Honeymoon Tour Package For Bangkok And Pattaya -  Best Place To Visit For Couple In Bangkok</title>
                <meta name="description" content="Book honeymoon tour package for bangkok and pattaya and explore the best place to visit for couple in Bangkok. Plan a honeymoon in bangkok pattaya today." />
                <meta name="keywords" content="honeymoon tour package for bangkok and pattaya, trip to bangkok pattaya for couple from india, best place to visit for couple in bangkok" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/honeymoon-package-to-greece-from-india" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/honeymoon-tour-package-for-bangkok-and-pattaya" />
                <meta property="og:title" content="Get Your Honeymoon Tour Package For Bangkok And Pattaya -  Best Place To Visit For Couple In Bangkok" />
                <meta property="og:description" content="Book honeymoon tour package for bangkok and pattaya and explore the best place to visit for couple in Bangkok. Plan a honeymoon in bangkok pattaya today." />
                <meta property="og:image" content="https://www.tripzygo.in/images/international_packages/honeymoon_tour_package_for_bangkok_and_pattaya/1.webp" />
            </Head>
<ShareButton/>
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">Honeymoon Tour Package For Bangkok And Pattaya</h2>
                                    ...
                                    <div className="thumbnail-///images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/honeymoon_tour_package_for_bangkok_and_pattaya/1.webp" alt="honeymoon tour package for bangkok and pattaya" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/honeymoon_tour_package_for_bangkok_and_pattaya/2.webp" alt="honeymoon tour package for bangkok and pattaya" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/honeymoon_tour_package_for_bangkok_and_pattaya/3.webp" alt="trip to bangkok pattaya for couple from india" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/honeymoon_tour_package_for_bangkok_and_pattaya/4.webp" alt="trip to bangkok pattaya for couple from india" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/honeymoon_tour_package_for_bangkok_and_pattaya/5.webp" alt="bangkok pattaya itinerary 6 days" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/honeymoon_tour_package_for_bangkok_and_pattaya/6.webp" alt="bangkok pattaya itinerary 6 days" />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/honeymoon_tour_package_for_bangkok_and_pattaya/1.webp" alt="family kerala tour package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/honeymoon_tour_package_for_bangkok_and_pattaya/2.webp" alt="family kerala tour package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/honeymoon_tour_package_for_bangkok_and_pattaya/3.webp" alt="family kerala tour package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/honeymoon_tour_package_for_bangkok_and_pattaya/4.webp" alt="family kerala tour package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/honeymoon_tour_package_for_bangkok_and_pattaya/5.webp" alt="family kerala tour package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/honeymoon_tour_package_for_bangkok_and_pattaya/6.webp" alt="family kerala tour package" />
                                                    </div>
                                                </SwiperSlide>
                                ...
                                <div className="description mb-2">
                                    <div className="row">
                                        <div class="desc-box bg-grey p-4 rounded ">
                                            ...
                                            <div>Thinking of taking your partner on an amazing trip? How about a trip to Bangkok and Pattaya?</div>
                                            <div class="mb-0">Bangkok and Pattaya are amazing destinations for enjoying at the best.</div>
                                            <div>Be it chilling at the beaches or having the fun of the night life, there are the most amazing and best places to visit for couple in Bangkok and Pattaya.</div>
                                            <div>So, a trip to Bangkok Pattaya for couple from India would be an amazing idea and your partner will love this gift from you.</div>
                                            <div>Surprise your partner by promising them a loving and romantic experience on an amazing couple tour to Bangkok and Pattaya.</div>
                                            <div>Book the Honeymoon Tour Package For Bangkok And Pattaya now.</div>
                                        </div>
                                ...
                                <div className="tour-includes mb-4">
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><i class="fa fa-inr pink mr-1" aria-hidden="true"></i> Total Tour Cost : INR 18,500/-*</td>
