    ...
    return (
        <div>
            <Head>
                ...
                <title>TripzyGo - Malaysia Tour Package For Couple From India - Tour To Malaysia</title>
                <meta name="description" content="Malaysia is the perfect romantic getaway for couples from India. Check out our Malaysia tour package for couples and book your tour to Malaysia from India." />
                <meta name="keywords" content="malaysia tour package for couple from india, malaysia romantic getaway from india, tour to malaysia from india" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/malaysia-tour-package-for-couple-from-india" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/malaysia-tour-package-for-couple-from-india" />
                <meta property="og:title" content="Malaysia Tour Package For Couple From India - Tour To Malaysia" />
                <meta property="og:description" content="Malaysia is the perfect romantic getaway for couples from India. Check out our Malaysia tour package for couples and book your tour to Malaysia from India." />
                <meta property="og:image" content="https://www.tripzygo.in/images/international_packages/malaysia_tour_package_for_couple_from_india/1.webp" />
            </Head>
<ShareButton/>
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">Malaysia Tour Package For Couple From India</h2>
                                    ...
                                    <div className="thumbnail-/images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/malaysia_tour_package_for_couple_from_india/1.webp" alt="malaysia tour package for couple from india" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/malaysia_tour_package_for_couple_from_india/2.webp" alt="malaysia tour package for couple from india" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/malaysia_tour_package_for_couple_from_india/3.webp" alt=" malaysia romantic getaway from india" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/malaysia_tour_package_for_couple_from_india/4.webp" alt="malaysia romantic getaway from india " />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/malaysia_tour_package_for_couple_from_india/5.webp" alt="tour to malaysia from india" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/malaysia_tour_package_for_couple_from_india/6.webp" alt="tour to malaysia from india" />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 mb-2 ">
                                            <div class="desc-box bg-grey p-4 rounded ">
                                                ...
                                                <div>A honeymoon to an island country! Isn’t that an exciting idea? And what with the place being Malaysia, a land of beautiful beaches and pleasant rainforests.</div>
                                                <div class="mb-0">Not only that, you can find the most amazing cultural influences of four different countries here.</div>
                                                <div>With colonial buildings and shopping districts that speak of the cultural influences of Malaysia, Europe, China, and India, you and your partner can have an amazing time enjoying different cultures in one single country.</div>
                                                <div>You can have a more romantic time walking down the beaches and rainforests where there are many romantic activities and adventures to enjoy.</div>
                                                <div>This 4 Nights 5 Days Malaysia tour package for couple from India will be the most amazing and memorable romantic trip of your life. You don’t want to miss this chance.</div>
                                                <div>Surprise your partner with this amazing and intimate Malaysia trip experience by booking this customised tour to Malaysia from India designed just for you.</div>
                                ...
                                <div class="tour-includes mb-4">
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><i class="fa fa-inr pink mr-1" aria-hidden="true"></i> Total Tour Cost : INR 17,800/-*  </td>
