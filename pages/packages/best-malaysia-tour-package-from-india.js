    ...
    return (
        <div>
            <Head>
                ...
                <title>TripzyGo - Best Malaysia Tour Package From India - Book Malaysia Package From India</title>
                <meta name="description" content="Best Malaysia tour package from India. We've got the perfect itinerary, with all the best places to visit in Malaysia. Book your Malaysia package from India." />
                <meta name="keywords" content="best malaysia tour package from india, malaysia package from india, best places to visit in malaysia" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/best-malaysia-tour-package-from-india" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/best-malaysia-tour-package-from-india" />
                <meta property="og:title" content="Best Malaysia Tour Package From India - Book Malaysia Package From India " />
                <meta property="og:description" content="Best Malaysia tour package from India. We've got the perfect itinerary, with all the best places to visit in Malaysia. Book your Malaysia package from India." />
                <meta property="og:image" content="https://www.tripzygo.in/images/international_packages/best_malaysia_tour_package_from_india/1.webp" />
            </Head>
<ShareButton/>
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">Best Malaysia Tour Package From India</h2>
                                    ...
                                    <div className="thumbnail-images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/best_malaysia_tour_package_from_india/1.webp" alt="best malaysia tour package from india" />

                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/best_malaysia_tour_package_from_india/2.webp" alt="best malaysia tour package from india" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/best_malaysia_tour_package_from_india/3.webp" alt="malaysia package from india" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/best_malaysia_tour_package_from_india/4.webp" alt="malaysia package from india" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/best_malaysia_tour_package_from_india/5.webp" alt="best places to visit in malaysia" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/best_malaysia_tour_package_from_india/6.webp" alt="best places to visit in malaysia" />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-12 col-md-6 mb-2 ">
                                            <div className="desc-box bg-grey p-4 rounded ">
                                                ...
                                                <div>Malaysia takes you to an amazing land of rich and vivid cultural influences. </div>
                                                <div class="mb-0">From colonial buildings, skyscrapers, and shopping complexes to beaches and rainforests, Malaysia is a vast land with many beautiful experiences within its hold.</div>
                                                <div>You can uncover all the beautiful and amazing experiences that Malaysia has to offer on this amazing 3 nights and 4 days trip to Malaysia that will take you to the best places in the island with an amazing tour itinerary designed to offer you the most memorable holiday of your life.</div>
                                                <div>Plan the most amazing and memorable trip of your life with the most fantastic and best Malaysia tour package from India designed to make you explore the best of this amazing island on a most exciting journey.</div>
                                                <div>Book the Malaysia package from India on special deals and offers by getting in touch with a TripzyGo tour specialist.</div>
                                            </div>
                                        </div>
                                ...
                                <div className="tour-includes mb-4">
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><i class="fa fa-inr pink mr-1" aria-hidden="true"></i> Total Tour Cost : INR 15,200/-*</td>
