    ...
    return (
        <div>
            <Head>
                ...
                <title>TripzyGo - Paris and Amsterdam tour package from India - Paris Amsterdam Trip</title>
                <meta name="description" content="Paris Amsterdam Trip - Book the Paris Amsterdam tour package from India. Our Paris and Amsterdam tour package includes everything you need for a perfect trip." />
                <meta name="keywords" content="Paris Amsterdam tour package from India, Paris and Amsterdam tour package, Paris Amsterdam trip" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/paris-amsterdam-honeymoon-tour-package-from-india" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/paris-amsterdam-honeymoon-tour-package-from-india" />
                <meta property="og:title" content="Paris and Amsterdam tour package from India - Paris Amsterdam Trip" />
                <meta property="og:description" content="Paris Amsterdam Trip - Book the Paris Amsterdam tour package from India. Our Paris and Amsterdam tour package includes everything you need for a perfect trip." />
                <meta property="og:image" content="https://www.tripzygo.in/images/international_packages/paris_amsterdam_package_an_utterly_romantic_honeymoon/1.webp" />
            </Head>
<ShareButton/>
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">Paris Amsterdam Honeymoon Tour Package From India</h2>
                                    ...
                                    <div className="thumbnail-images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/paris_amsterdam_package_an_utterly_romantic_honeymoon/1.webp" alt="Paris Amsterdam tour package from India" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/paris_amsterdam_package_an_utterly_romantic_honeymoon/2.webp" alt="Paris Amsterdam tour package from India" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/paris_amsterdam_package_an_utterly_romantic_honeymoon/3.webp" alt="Paris and Amsterdam tour package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/paris_amsterdam_package_an_utterly_romantic_honeymoon/4.webp" alt="Paris and Amsterdam tour package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/paris_amsterdam_package_an_utterly_romantic_honeymoon/5.webp" alt="Paris Amsterdam trip" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/paris_amsterdam_package_an_utterly_romantic_honeymoon/6.webp" alt="Paris Amsterdam trip" />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 mb-2 ">
                                            <div class="desc-box bg-grey p-4 rounded ">
                                                ...
                                                <div>Paris and Amsterdam speak of romance and intimacy. </div>
                                                <div class="mb-0"> You think of a romantic place and you just can’t miss out on Paris and Amsterdam. </div>
                                                <div>So, how about booking a romantic Paris and Amsterdam tour package?</div>
                                                <div>Our  Paris Amsterdam tour package from India  is designed with the most amazing tour itinerary to offer you a romantic, intimate, and charming experience in these beautiful and attractive places that have all the love and intimacy of the world to offer.</div>
                                                <div>Enjoy a visit to the Eiffel Tower and walk around the most beautiful places in Paris and Amsterdam on your Paris Amsterdam trip and come back with a bag full of intimate memories that you will cherish forever.</div>
                                                <div>Book your Paris Amsterdam tour package from India now.</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-6 mb-2">
                                            <div class="desc-box bg-grey p-4 rounded">
                                                ...
                                                <div class="mb-0"><i class="fa fa-arrow-right" aria-hidden="true" style={{ fontSize: "13px" }}></i> Investigate the Louver Royal residence</div>
                                                <div class="mb-0"><i class="fa fa-arrow-right" aria-hidden="true" style={{ fontSize: "13px" }}></i> Wonder about an Old style Expressive dance at the Palais Garnier</div>
                                                ...
                                                <div class="mb-0"><i class="fa fa-arrow-right" aria-hidden="true" style={{ fontSize: "13px" }}></i> Drench yourself in culture at Westergas</div>
                                                <div class="mb-0"><i class="fa fa-arrow-right" aria-hidden="true" style={{ fontSize: "13px" }}></i> Look at the exhibition halls and great structures in Museumplein</div>
                                                <div class="mb-0"><i class="fa fa-arrow-right" aria-hidden="true" style={{ fontSize: "13px" }}></i> Journey past waterway houses and extensions</div>
