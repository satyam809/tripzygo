    ...
    return (
        <div>
            <Head>
                ...
                <title>TripzyGo - Germany Trip Package From India With The Best Tour Itinerary </title>
                <meta name="description"
                    content="Get Germany trip package from India with the best Germany tour itinerary! Book your customized Germany tour package from India today! Grab the best deals now." />
                <meta name="keywords"
                    content="Germany trip package from India, Germany tour package from India, Germany tour itinerary" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/germany-trip-package-from-india" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/germany-trip-package-from-india" />
                <meta property="og:title" content="Germany Trip Package From India With The Best Tour Itinerary " />
                <meta property="og:description" content="Get Germany trip package from India with the best Germany tour itinerary! Book your customized Germany tour package from India today! Grab the best deals now." />
                <meta property="og:image" content="https://www.tripzygo.in/images/international_packages/germany_trip_package_from_india/1.webp" />
            </Head>
<ShareButton/>
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">Germany Trip Package from India</h2>
                                    ...
                                    <div className="thumbnail-///images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/germany_trip_package_from_india/1.webp" alt="Germany tour itinerary" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/germany_trip_package_from_india/2.webp" alt="Germany tour itinerary" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/germany_trip_package_from_india/3.webp" alt="Germany tour package from India" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/germany_trip_package_from_india/4.webp" alt="Germany tour package from India" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/germany_trip_package_from_india/5.webp" alt="Germany trip package from India" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/germany_trip_package_from_india/6.webp" alt="Germany trip package from India" />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
                                    ...
                                    <div className="row">
                                        <div class="col-lg-12 col-md-6 mb-2 ">
                                            <div class="desc-box bg-grey p-4 rounded ">
                                                ...
                                                <div>When you’re looking for the best breads and beer, well, you cannot miss out on Germany. </div>
                                                <div class="mb-0">Germany is a amazing country with so much to witness.</div>
                                                <div>The place is famous for its culture, tradition, cuisines, atmosphere, and many more things.</div>
                                                <div>You would love the cool atmosphere of Germany with cities packed in snow and having the best beer during the cold seasons as you’re getting cosy in the warm treatment of the place, it’s just a feeling like never before.</div>
                                                <div>All of this definitely brings a Germany trip to mind. </div>
                                                <div>Well, plan your trip now with this amazing Germany tour package from India which covers the best places in Germany in the tour itinerary.</div>
                                                <div>With this Germany trip package from India, you’ll be in for lots of fun and exciting activities to do in Germany and the trip will be a memory of a lifetime for you.</div>
                                                <div>So, what are you waiting for? Book this exciting Germany tour package from India and spend one of the most memorable and fantastic vacations you ever had.</div>
                                            </div>
                                        </div>
                                    ...
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><i class="fa fa-inr pink mr-1" aria-hidden="true"></i> Total Tour Cost : INR 79,500/-*  </td>
