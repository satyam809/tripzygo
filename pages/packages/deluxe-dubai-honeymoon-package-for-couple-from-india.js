...
export default function test() {
    ...
    return (
        <div>
            <Head>
                <title>TripzyGo - Book Dubai Honeymoon Package Tour For Couple From India</title>
                <meta name="description" content="Book Dubai honeymoon package for the most romantic Dubai tour for couple from India. Plan your Dubai trip from India for couple today for a romantic honeymoon." />
                <meta name="keywords" content="dubai honeymoon package for couple from india, dubai trip from india for couple, dubai tour for couple from india" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/deluxe-dubai-honeymoon-package-for-couple-from-india" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/deluxe-dubai-honeymoon-package-for-couple-from-india" />
                <meta property="og:title" content="Book Dubai Honeymoon Package Tour For Couple From India" />
                <meta property="og:description" content="Book Dubai honeymoon package for the most romantic Dubai tour for couple from India. Plan your Dubai trip from India for couple today for a romantic honeymoon." />
                <meta property="og:image" content="https://www.tripzygo.in/images/international_packages/deluxe_dubai_honeymoon_package_for_couple_from_india\1.webp" />
            </Head>
<ShareButton/>
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">Deluxe Dubai Honeymoon Package For Couple From India</h2>
                                    ...
                                    <div className="thumbnail-images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/deluxe_dubai_honeymoon_package_for_couple_from_india\1.webp" alt="dubai honeymoon package for couple from india" />

                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/deluxe_dubai_honeymoon_package_for_couple_from_india\2.webp" alt="dubai honeymoon package for couple from india" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/deluxe_dubai_honeymoon_package_for_couple_from_india\3.webp" alt="dubai trip from india for couple" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/deluxe_dubai_honeymoon_package_for_couple_from_india\4.webp" alt="dubai trip from india for couple" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/deluxe_dubai_honeymoon_package_for_couple_from_india\5.webp" alt="dubai tour for couple from india" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/deluxe_dubai_honeymoon_package_for_couple_from_india\6.webp" alt="dubai tour for couple from india" />
                                                    </div>
                                                </SwiperSlide>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 mb-2 ">
                                            <div class="desc-box bg-grey p-4 rounded ">
                                                ...
                                                <div>Thinking of a honeymoon? Well, think of a Dubai tour for couple. </div>
                                                <div class="mb-0">Doesn’t it feel heavenly? Well, it surely does. </div>
                                                <div>The feel of being in and around the Burj Khalifa with your partner, romancing around the luxurious cafes and cruise in Dubai, shopping for the most amazing things in the Dubai malls and streets, all this is a beautiful experience and you can live it all on one amazing Dubai trip from India for couple.</div>
                                                <div>That’s what we have planned for you with this amazing Dubai honeymoon package for couple from India.</div>
                                                <div>With this package you will have the most amazing Dubai trip with your partner romancing all around the city making beautiful memories and moments.</div>
                                                <div>So, don’t keep thinking. Plan this amazing Dubai tour with this deluxe Dubai honeymoon package for couple from India.</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
