    ...
    return (
        <div>
            <Head>
                ...
                <title>TripzyGo - United Kingdom Holiday Package - UK Travel From India </title>
                <meta name="description"
                    content="Are you looking for a United Kingdom Holiday Package? Travel to United Kingdom easily and affordably in one travel package. Book your UK travel from India today." />
                <meta name="keywords"
                    content="UK travel from India, United Kingdom Holiday package, travel to united kingdom" />
                <link rel="icon" href="/icon.png" />
                <link rel="canonical" href="https://www.tripzygo.in/packages/united-kingdom-holiday-package" />
                <meta property="og:url" content="https://www.tripzygo.in/packages/united-kingdom-holiday-package" />
                <meta property="og:title" content="United Kingdom Holiday Package - UK Travel From India " />
                <meta property="og:description" content="Are you looking for a United Kingdom Holiday Package? Travel to United Kingdom easily and affordably in one travel package. Book your UK travel from India today." />
                <meta property="og:image" content="https://www.tripzygo.in/images/international_packages/united_kingdom_holiday_package/1.webp" />
            </Head>
<ShareButton/>
                            ...
                            <div className="single-content">
                                <div className="single-full-title mb-2 pb-2">
                                    <div className="single-title">
                                        <h2 className="mb-1">United Kingdom Holiday Package</h2>
                                    ...
                                    <div className="thumbnail-images position-relative">
                                        <div className="rounded overflow-hidden">
                                            ...
                                            >
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/united_kingdom_holiday_package/1.webp" alt="travel to united kingdom" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/united_kingdom_holiday_package/2.webp" alt="travel to united kingdom" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/united_kingdom_holiday_package/3.webp" alt="United Kingdom Holiday package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/united_kingdom_holiday_package/4.webp" alt="United Kingdom Holiday package" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/united_kingdom_holiday_package/5.webp" alt="UK travel from India" />
                                                    </div>
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <div>
                                                        <img className='blog_image' src="/images/international_packages/united_kingdom_holiday_package/6.webp" alt="UK travel from India" />
                                                    </div>
                                                </SwiperSlide>
                                            </Swiper>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 mb-2 ">
                                            <div class="desc-box bg-grey p-4 rounded ">
                                                ...
                                                <div>A UK trip is travel goals for many. </div>
                                                <div class="mb-0">With almost every amazing thing to find in the UK including art, music, literature, history, scenic landscapes, luxury bars, restaurants, and lounges; there’s just everything to visit and see in the United Kingdom. </div>
                                                <div>So, you definitely don’t want to miss a UK travel from India and there’s no reason you should when we have an amazing United Kingdom Holiday package customised just for you.</div>
                                                <div>With this holiday package, you are set for the most exciting and wholesome holiday experience of your life.</div>
                                                <div>Grab the opportunity and book your United Kingdom holiday package with us now.</div>
                                            </div>
                                        </div>
                                    ...
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><i class="fa fa-inr pink mr-1" aria-hidden="true"></i> Total Tour Cost : INR 93,400/-*   </td>
